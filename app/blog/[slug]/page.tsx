    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": `https://eldercarepeek.com/blog/${slug}/`,
            },
          }),
        }}
      />
      ...
      <header className="mb-8">
        ...
        <div className="text-xs text-slate-400 flex items-center gap-3">
          ...
          <span>· ElderCarePeek Editorial Team</span>
        </div>
      </header>
      ...
      <div className="mt-12 p-6 bg-teal-50 border border-teal-200 rounded-xl">
        ...
        <p className="text-slate-600 text-sm mb-4">
          Use our free tools to compare senior care costs by state and find the
          right care options for your family.
        </p>

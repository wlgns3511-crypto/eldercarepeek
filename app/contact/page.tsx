...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with the ElderCarePeek team.",
};
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-6">
        ...
        <p className="mb-2">
          <strong>Email:</strong>{" "}
          <a href="mailto:contact@eldercarepeek.com" className="text-teal-600 hover:underline">
            contact@eldercarepeek.com
          </a>
        </p>
      ...
      <p>
        Your feedback helps us improve ElderCarePeek for everyone. If you notice any data discrepancies or have ideas
        for new features, please let us know.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">Data Corrections</h2>
      <p>
        Our data is sourced from the Genworth Cost of Care Survey and CMS databases. If you believe there is an error

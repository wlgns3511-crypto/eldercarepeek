          ...
          <div className="max-w-5xl mx-auto px-4 py-6 text-sm text-slate-500">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100">
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs">
                ...
                <a href="https://guidebycity.com" className="hover:text-teal-600">City Guides</a>
                <a href="https://degreewize.com" className="hover:text-teal-600">Colleges</a>
                <a href="https://caloriewize.com" className="hover:text-teal-600">Nutrition</a>
                <a href="https://nameblooms.com" className="hover:text-teal-600">Baby Names</a>
                <a href="https://vocabwize.com" className="hover:text-teal-600">Vocabulary</a>
                <a href="https://calcpeek.com" className="hover:text-teal-600">Calculators</a>
                <a href="https://tariffpeek.com" className="hover:text-teal-600">HS Codes &amp; Tariffs</a>

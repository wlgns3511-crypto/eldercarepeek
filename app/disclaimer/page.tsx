...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Disclaimer and limitations of liability for ElderCarePeek.",
...
export default function DisclaimerPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        The information provided on ElderCarePeek is for general informational and educational purposes only. While we
      ...
      <p>
        Data displayed on ElderCarePeek is sourced from publicly available databases and third-party sources. While we
      ...
      <p>
        ElderCarePeek displays third-party advertisements through Google AdSense and other ad networks. These advertisements
        are provided by third parties and do not imply endorsement by ElderCarePeek. We are not responsible for the content
      ...
      <p>
        In no event shall ElderCarePeek, its owners, operators, or contributors be liable for any direct, indirect,
